...
# The worker never imports app.main/routers (which transitively pull in every
# model), so Conversation's relationship to Feedback won't resolve unless
# this is imported explicitly — same reason migrations/env.py needs it.
from app.feedback import models as feedback_models  # noqa: F401
from app.worker.jobs import JOB_HANDLERS
