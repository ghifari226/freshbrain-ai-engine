...
from app.ai.llm.anthropic.stub import create_stub_message
from app.core.config import get_settings


# Adapter provider mengisolasi SDK Anthropic dari logika utama aplikasi.
class AnthropicClient:
    ...
    async def create_message(
        ...
        *,
        ...
        # Stub membuat pengembangan lokal deterministik tanpa memanggil API berbayar.
